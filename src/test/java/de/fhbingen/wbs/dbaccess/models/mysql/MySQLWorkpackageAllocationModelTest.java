...
public class MySQLWorkpackageAllocationModelTest {
    ...
    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#addNewWorkpackageAllocation(de.fhbingen.wbs.dbaccess.data.WorkpackageAllocation)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#getWorkpackageAllocation()}
     * .
     */
    @Test
    public final void testGetWorkpackageAllocation() {
        List<WorkpackageAllocation> wpaList =
                wpAllocModel.getWorkpackageAllocation();
        assertThat(wpaList.size(), equalTo(20));
    }

    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#getWorkpackageAllocation(int)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#getWorkpackageAllocationJoinWP()}
     * .
     */
    @Test
    public final void testGetWorkpackageAllocationJoinWP() {
        List<Workpackage> wpList =
                wpAllocModel.getWorkpackageAllocationJoinWP(2);
        String statement =
                "SELECT * "
    ...
    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#getWorkpackageAllocationJoinWP(java.util.Date, java.util.Date)}
     * .
     */
    @Test
        ...
        try {
            ...
            String statement =
                    "SELECT * "
                            ...
                            + startDateCalcStr
                            + "' AND wp.start_date_calc <= '" + endDateCalcStr
                            + "';";
            ResultSet rslt = SQLExecuter.executeQuery(statement);
            int rsltSize = 0;
            try {
    ...
    /**
     * Test method for
     * {@link de.fhbingen.wbs.dbaccess.models.mysql.MySQLWorkpackageAllocationModel#deleteWorkpackageAllocation(int, int)}
     * .
     */
    @Test
