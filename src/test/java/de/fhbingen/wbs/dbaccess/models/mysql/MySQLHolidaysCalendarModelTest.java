...
public class MySQLHolidaysCalendarModelTest {
    ...
    public final void testGetHolidayCalendarDateDateBoolean() {
        ...
        try {
            Timestamp from =
                    new Timestamp(dateFormat.parse("2014-12-01 00:00:00")
                            .getTime());
            Timestamp to =
                    new Timestamp(dateFormat.parse("2014-12-31 00:00:00")
                            .getTime());

            hcList =
                    hcModel.getHolidayCalendar(
                            dateFormat.parse("2014-12-01 00:00:00"),
                            dateFormat.parse("2014-12-31 00:00:00"), false);

            String statement =
                    "SELECT * FROM holidays_calendar " + "WHERE "
