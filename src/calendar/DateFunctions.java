...
public class DateFunctions {
	...
	/**
	 * Dies Methode lifert ein Datum als String so formatiert, dass es direkt in eine SQL Query fuer eine Access Datenbank verwendet werden kann.<br/>
	 * Der Datums-String besteht aus dem Tag, den Stunden, den Minuten und den Sekunden (Sekunden sind immer 00).<br/>
	 * Fromat: #MM/DD/YYYY HH:MM:SS#
	 * @param d Datum, das in einen Sting umgewandelt werden soll
	 ...
	 * @param d1 Erstes zu vergleichendes Datum vom Typ Date
	 * @param d2 Zweites zu vergleichendes Datum vom Typ Date
