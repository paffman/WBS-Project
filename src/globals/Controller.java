 ...
 * Enthaelt ausserdem ausserdem Globale Statische Wert wie freie Tage (Samstag/Sonntag), Arbetiszeiten und Formatierungen fuer Datum und Uhrzeit
 * 
...
public class Controller {
	...
	/**
	 * Kann an showConsoleMessage uebergeben werden um die Nachricht als Dauerberechnungs-Debugging zu kennzeichnen
	 */
	public static final int TIME_CALCULATION_DEBUG = 0;
	
	/**
	 * Kann an showConsoleMessage uebergeben werden um die Nachricht als Vorgaenger/Nachfolger-Debugging zu kennzeichnen
	 */
	public static final int HIERACHY_DEBUG = 1;
	
	public static final SimpleDateFormat DATE_DAY = new SimpleDateFormat("dd.MM.yyyy");
	public static final SimpleDateFormat DATE_DAY_TIME = new SimpleDateFormat("dd.MM.yyyy HH:mm");
	 ...
	 */
	public static final int[] FREE_DAYS = new int[] { Calendar.SATURDAY, Calendar.SUNDAY };
	...
	/**
	 * Wenn true, wird Debugging-Info zur Dauerberechnung in die Datei Log.txt auf dem Desktop geschrieben
	 */
	private static boolean time_calculation = false;
	
	/**
	 * Wenn true, wird Debugging-Info zur Vorgaenger/Nachfolger-Berechnung in die Datei Log.txt auf dem Desktop geschrieben
	 */
...
//	private static PrintStream outNor = System.out;
	 ...
	 * @param message
	 * @param type siehe static final _DEBUG Datenelemente
	 */
	 ...
	 * Gibt eine Nachricht auf der Konsole oder in die Debugging-Datei aus
	 * @param object
	 * @param error wenn true wird auf Error-Konsole oder Debug ausgegeben
	 * @param type siehe static final _DEBUG Datenelemente
	 */
	public static void showConsoleMessage(Object object, boolean error, int type) {
	 ...
	 * @param type siehe static final _DEBUG Datenelemente
	 */
	public static void showConsoleMessage(String message, boolean error, int type) {
		if(outErr == null){
			try {
				String path = System.getProperty("user.home") + "/Desktop/Log.txt";
				path.replace("\\", "/");
