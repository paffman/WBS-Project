...
public interface DependenciesModel {
     ...
     * 
     * @param dependency
     *            The dependency which is added to the project.
     */
    boolean addNewDependency(Dependency dependency);
     ...
     * 
     * @param predecessorWpID
     *            Workpackage which must be done before another workpackage.
     * @param succesorWpID
     *            Workpackage which has a workpackage that must be done before
     *            it.
     * @return success of deletion.
     */
    boolean deleteDependency(int predecessorWpID, int successorWpID);
