...
/**
 * A simple container class representing a Baseline. It mirrors all the
 * baseline fields in the baseline table.
 */
public class Baseline {
     ...
     *
     * @param fid_project The fid from the project
     */
     ...
     *
     * @param bl_date The baselines date
     */
     ...
     *
     * @param description The description of the baseline
     */
