...
public class HolidayCalendar {
     ...
     */
    public static final HolidayCalendar fromResultSet(final ResultSet resSet) {
     ...
     */
    public final void setBegin_time(final Date begin_time) {
     ...
     *            the end_time to set
     */
    public final void setEnd_time(final Date end_time) {
    ...
    /**
     * @param full_time
     *            the full_time to set
     */
    public final void setFull_time(final boolean full_time) {
