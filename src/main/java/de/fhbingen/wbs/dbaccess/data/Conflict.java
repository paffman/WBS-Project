...
/**
 * A simple container class representing a Conflict. It mirrors all the conflict
 * fields in the conflicts table.
 */
public class Conflict {
     ...
     *
     * @param fid_wp
     *            The referenced work packages id
     */
     ...
     *
     * @param fid_wp_affected
     *            The affected work packages id.
     */
    ...
    public String toString() {
        return id + " " + fid_wp + " " + fid_wp_affected + " " + fid_emp + " "
                + reason + " " + occurence_date;
    }
}
