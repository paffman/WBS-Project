...
public interface BaselineModel {
     ...
     *
     * @param line
     *            The baseline which is added to the project.
     * @return success of the insertion.
     */
    boolean addNewBaseline(Baseline line);
     ...
     */
    List<Baseline> getBaseline();

    /**
     * A method to get a specific baseline.
     *
     * @param baselineID
     *            The id from the specific baseline.
     * @return Returns the selected baseline.
     */
    Baseline getBaseline(int baselineID);
