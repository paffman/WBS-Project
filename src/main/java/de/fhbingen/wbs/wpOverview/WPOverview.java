...
public class WPOverview {
    ...
    public final void readAP(final boolean isNewAp) {
        if (getSelectedWorkpackage() != null) {
            ...
            JOptionPane.showMessageDialog(WPOverview.gui, messageStrings
                    .selectWorkPackageToAddNew());
        }
    }
     ...
     */
    public static void throwConflict(final ConflictController conflict) {
        if (gui != null) {
