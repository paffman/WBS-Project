...
public class InfoBox extends JDialog{
	...
	//altes info Bild /de.fhbingen.wbs.globals/info.old (jpg)
	Image pictInfo = Toolkit.getDefaultToolkit().getImage(this.getClass()
            .getResource("/de/fhbingen/wbs/globals/info.jpg"));
	JButton close;
