...
-- --------------------------------------------------------
-- work_effort_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- baseline_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- holidays_calendar_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- holidays_calendar_update_by_id( int id, alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- conflicts_new( alle Felder auﬂer id )
-- r
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- employee_calendar_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- employee_calendar_update_by_id( int id, alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- employees_new( alle Felder auﬂer id, string password )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- employees_update_by_id( alle Felder auﬂer id und login, opt string password )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- planned_value_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
...
-- --------------------------------------------------------
-- project_new( alle Felder auﬂer id )
-- rw
-- --------------------------------------------------------
DELIMITER //
